...
from app.api import research, insights, content, review, scheduler, projects, notifications, niche, analytics, calendar, brand_brain
...
app.include_router(brand_brain.router, prefix="/api/brand-brain", tags=["brand-brain"])
