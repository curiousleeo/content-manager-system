...
const QUICK_ACTIONS = [
  ...
  { href: "/content",   label: "Generate Batch",      desc: "Create multiple posts at once",        icon: Zap,      bg: "rgba(107,47,217,0.10)", color: "var(--purple-l)" },
  ...
  { href: "/analytics", label: "View Calendar",       desc: "See your scheduled post timeline",     icon: Calendar, bg: "rgba(107,47,217,0.10)", color: "var(--purple-l)" },
];
...
export default function DashboardPage({ firstName }: { firstName: string }) {
  ...
  return (
    <>
    <div style={{ padding: "32px 36px 80px", position: "relative" }}>
      ...
      <div style={{
        ...
        height: "700px",
        borderRadius: "50%",
        background: "radial-gradient(circle, rgba(107,47,217,0.07) 0%, transparent 70%)",
        pointerEvents: "none",
        zIndex: 0,
      }} />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1.3fr", gap: "16px", marginBottom: "32px" }}>
          ...
          {/* Card 1 — Posts This Month (gold top-accent) */}
          <div style={{ background: "var(--bg-card)", borderRadius: "12px", padding: "20px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ background: "var(--bg-elev)", borderRadius: "12px", padding: "20px" }}>
            ...
            {QUICK_ACTIONS.map(({ href, label, desc, icon: Icon, bg, color }) => (
              <Link
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 24px rgba(107,47,217,0.12)";
                }}
                onMouseLeave={(e) => {
        ...
        <div>
          ...
          {topPosts.length === 0 ? (
            <div style={{ background: "var(--bg-card)", borderRadius: "12px", padding: "56px 0", textAlign: "center" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "16px" }}>
              {topPosts.slice(0, 3).map((post) => (
                <div key={post.tweet_id} style={{ background: "var(--bg-card)", borderRadius: "12px", padding: "18px", position: "relative", overflow: "hidden" }}>
                  {/* Gold shimmer line */}
                  <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "2px", background: "linear-gradient(90deg, transparent, var(--gold), transparent)" }} />
                  ...
                  <div style={{ display: "flex", gap: "18px", paddingTop: "12px", borderTop: "1px solid rgba(255,255,255,0.04)" }}>
